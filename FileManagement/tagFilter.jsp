...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-142" data-genuitec-path="/FileManagement22/WebRoot/tagFilter.jsp">
 <div id="contextWrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-142" data-genuitec-path="/FileManagement22/WebRoot/tagFilter.jsp">
        <!--sidebar-->
                        ...
                        <div class="ui dropdown item">
                           <i class=" ion-person big icon"></i>
                            <div class="menu">
                              ...
                              <a class="item" href="changeAccount.jsp">切换账户</a>
                              <a class="item" href="index.jsp">注销账户</a>
                            </div>
                        </div>
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui  segment">
                                <div class="ui vertical fluid menu no-border no-radius">
                                    <button class="ui fluid teal button no-radius" onclick="window.location.href ='servlet/TagFilterServlet?tag=all&page=private'">
                                       <i class="tags icon"></i> 全部
                                    </button>
                                    <%ArrayList<String> taglist =(ArrayList<String>)session.getAttribute("taglist");
                                if(taglist!=null){
                                   ...
                                   <a class="item" href="/FileManagement/servlet/TagFilterServlet?tag=<%=tag%>&page=private"><%=tag%><i class="tag icon"></i></a>
                                    <%} }%>
					...
					note= note.substring(0,10)+"...";
                        ...
                        <tr>
                          ...
                          <td class="center">
						   ...
						   <a href="servlet/UpdateFileServlet?id=<%=file.getFileId()%>&from=tagFilter" 
						     title="编辑"><i class="edit icon"></i></a>
						   <a href="servlet/UserDeleteFileServlet?fileId=<%=file.getFileId()%>&from=tagFilter" 
                        ...
                        <% if((lastpage!=1)&&(lastpage!=0)){
                                if(thispage==1){%>
                                      ...
                                      <tfoot class="hiddenui">
                                        ...
                                        <a class="icon item" href="tagFilter.jsp?page=<%=thispage+1%>">
