...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-19" data-genuitec-path="/FileManagement22/WebRoot/log.jsp">
<script language="JavaScript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-19" data-genuitec-path="/FileManagement22/WebRoot/log.jsp"> 
if (window != top)
