...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-47" data-genuitec-path="/FileManagement22/WebRoot/popTag2.jsp">
<script language="JavaScript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-47" data-genuitec-path="/FileManagement22/WebRoot/popTag2.jsp"> 
if (window != top){
                        ...
                        <% if((lastpage!=1)&&(lastpage!=0)){
                                if(thispage==1){%>
                                      ...
                                      <tfoot class="hiddenui">
                                        ...
                                        <a class="icon item" href="popTag2.jsp?page=<%=thispage+1%>">
