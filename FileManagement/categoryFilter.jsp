...
<head>
    ...
    <link type="text/css" href="<%=basePath%>/semantic/dist/semantic.min.css" rel="stylesheet" />
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-6" data-genuitec-path="/FileManagement22/WebRoot/categoryFilter.jsp">
 <div id="contextWrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-6" data-genuitec-path="/FileManagement22/WebRoot/categoryFilter.jsp">
        <!--sidebar-->
   ...
   <div class="ui dropdown item labeled icon" onclick="window.location='/FileManagement/upload.jsp'" >
                    ...
                    <div class="sixteen wide tablet sixteen wide computer column">
                        <div class="ui segments">
                            <div class="ui segment">
                                <h3 class="ui header">我的文档</h3>
                            </div>
                            <div class="ui segment fullheight">
                                <div class="yellow ui buttons">
                                    <button class="ui button" onclick="window.location.href ='servlet/CategoryFilterServlet?category=all'">全部</button>
									<button class="ui button" onclick="window.location.href ='servlet/CategoryFilterServlet?category=class'">课程文档</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/CategoryFilterServlet?category=science'">科研文档</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/CategoryFilterServlet?category=work'">工作文档</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/CategoryFilterServlet?category=interest'">兴趣拓展</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/CategoryFilterServlet?category=other'">其他</button>	
                                </div>
                                ...
                                <div class="ui buttons">
                                    ...
                                    <button class="blue ui button" onclick="window.location.href ='servlet/FileOrderServlet?order=asc&from=category'" >按重要程度升序</button>
                                    <button class="red ui button" onclick="window.location.href ='servlet/FileOrderServlet?order=desc&from=category'" >按重要程度降序</button>
                                </div>
					...
					note= note.substring(0,10)+"...";
                        ...
                        <tr>
                          ...
                          <td class="center">
						   ...
						   <a href="servlet/UpdateFileServlet?id=<%=file.getFileId()%>&from=categoryFilter" 
						     title="编辑"><i class="edit icon"></i></a>
						   <a href="servlet/UserDeleteFileServlet?fileId=<%=file.getFileId()%>&from=category" 
                        ...
                        <% if((lastpage!=1)&&(lastpage!=0)){
                                if(thispage==1){%>
                                      ...
                                      <tfoot class="hiddenui">
                                        ...
                                        <a class="icon item" href="categoryFilter.jsp?page=<%=thispage+1%>">
                                        ...
                                        <th colspan="3">
                                        <div class="ui right floated pagination menu">
                                        <a class="icon item" href="typeFilter.jsp?page=<%=thispage-1%>">
                                             <i class="left chevron icon"></i>
                                        </a>
    ...
    <!--jquery-->
    <script src="<%=basePath%>plugins/Filterizr/dist/jquery.filterizr.min.js"></script>
    <!--semantic-->
    <script src="<%=basePath%>semantic/dist/semantic.min.js"></script>
    <!--semantic-->
<script src="<%=basePath%>plugins/cookie/js.cookie.js"></script>
    <script src="<%=basePath%>plugins/nicescrool/jquery.nicescroll.min.js"></script>

    <script data-pace-options='{ "ajax": false }' src="<%=basePath%>plugins/pacejs/pace.js"></script>
