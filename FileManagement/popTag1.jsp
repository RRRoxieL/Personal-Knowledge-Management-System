	...
	if (cookies!=null){
		...
		System.out.println(c.getName()+":"+c.getValue());
		    ...
		    if (rememberMe.equals("yes")){
	    		...
	    		response.sendRedirect("popTag2.jsp");
	   		}
			}
...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-46" data-genuitec-path="/FileManagement22/WebRoot/popTag1.jsp">


 <div id="contextWrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-46" data-genuitec-path="/FileManagement22/WebRoot/popTag1.jsp">
        <!--sidebar-->
			 ...
			 <div class="ui dropdown item displaynone scrolling">
                ...
                <div class="menu">
                   ...
                   热门类目
                    ...
                    <a class="item" href="/FileManagement/servlet/TagFilterServlet?tag=all&page=public">
                   热门标签
                    </a>
                </div>
            </div>
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui  segment">
                                <div class="ui vertical fluid menu no-border no-radius">
                                    <button class="ui fluid teal button no-radius" onclick="window.location.href ='servlet/TagFilterServlet?tag=all&page=public'">
                                ...
                                if(taglist!=null){
                                   ...
                                   <a class="item" href="/FileManagement/servlet/TagFilterServlet?tag=<%=tag%>&page=public"><i class="tag icon"></i><%=tag%></a>
                                    <%} }%>
                        ...
                        <% if((lastpage!=1)&&(lastpage!=0)){
                                if(thispage==1){%>
                                      ...
                                      <tfoot class="hiddenui">
                                        ...
                                        <a class="icon item" href="popTag1.jsp?page=<%=thispage+1%>">
