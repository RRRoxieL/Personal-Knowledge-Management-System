...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-158" data-genuitec-path="/FileManagement22/WebRoot/typeFilter.jsp">
 <div id="contextWrap" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc2-158" data-genuitec-path="/FileManagement22/WebRoot/typeFilter.jsp">
        <!--sidebar-->
                        ...
                        <div class="ui segments">
                            ...
                            <div class="ui segment fullheight">
                                <div class="yellow ui buttons">
                                    <button class="ui button" onclick="window.location.href ='servlet/TypeFilterServlet?type=all'">全部</button>
									<button class="ui button" onclick="window.location.href ='servlet/TypeFilterServlet?type=word'">Word</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/TypeFilterServlet?type=ppt'">PowerPoint</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/TypeFilterServlet?type=excel'">Excel</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/TypeFilterServlet?type=pdf'">PDF</button>
                                    <button class="ui button" onclick="window.location.href ='servlet/TypeFilterServlet?type=txt'">TXT</button>	
                                </div>
                                ...
                                <div class="ui buttons">
                                    ...
                                    <button class="blue ui button" onclick="window.location.href ='servlet/FileOrderServlet?order=asc&from=type'" >按重要程度升序</button>
                                    <button class="red ui button" onclick="window.location.href ='servlet/FileOrderServlet?order=desc&from=type'" >按重要程度降序</button>
                                </div>
					...
					note= note.substring(0,10)+"...";
                        ...
                        <tr>
                          ...
                          <td class="center">
						   ...
						   <a href="servlet/UpdateFileServlet?id=<%=file.getFileId()%>&from=typeFilter" 
						     title="编辑"><i class="edit icon"></i></a>
						   <a href="servlet/UserDeleteFileServlet?fileId=<%=file.getFileId()%>&from=typeFilter" 
...
<script src="js/customjs/custom-rating.js"></script>
</body>
