...
window.history.go(-1);
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-19" data-genuitec-path="/FileManagementAdmin/WebRoot/insertUser.jsp">
  <%
...
String errorInfo = (String)session.getAttribute("insertError");         // 获取错误属性
if(errorInfo != null) {
%>
<script type="text/javascript" language="javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-19" data-genuitec-path="/FileManagementAdmin/WebRoot/insertUser.jsp">
...
<div class="widget widget-4" style="margin-top: 0px;">
	<div class="widget-head" style="float: left;margin-top: 10px;margin-left:20px;">
	...
	<div class="widget-body" style="padding: 0;">
		 ...
		 <table border="0" style="margin: 20px 20px 0px 0px">
			  <tbody>
			    <tr>
			     ...
			     <a href="adminUserList.jsp"><div class="input"><button type="button" class="button button-rounded button-tiny" 
				style="width: 50px;margin-top:-20px;margin-left:-18px;">返回</button></div></a>
			     <%} 
			     ArrayList<User> users =(ArrayList<User>)session.getAttribute("users");
			
				String s= request.getParameter("thispage");
		...
		<form action="insertUserServlet?thispage=<%=thispage %>" method="post">
			 ...
			 %>
				...
				<tr class="selectable">
					...
					<td class="center">
						...
						<input type="button" value="取消" onclick="javascrtpt:window.location.href='adminUserListServlet'">
					</td>
				</tr>			
		  </tbody>
		</table></form>
