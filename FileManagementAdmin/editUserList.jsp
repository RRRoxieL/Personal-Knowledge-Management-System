...
window.history.go(-1);
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-16" data-genuitec-path="/FileManagementAdmin/WebRoot/editUserList.jsp">
...
if(errorInfo != null) {
%>
<script type="text/javascript" language="javascript" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc3-16" data-genuitec-path="/FileManagementAdmin/WebRoot/editUserList.jsp">
		...
		<div class="row">
			<div class="span12 relativeWrap">
				...
				<ul id="menu" class="hidden-phone">
					...
					<li class="active">
						<a href="" class="menuToggle">用户管理</a>
					</li>
				</ul>
...
<div class="widget widget-4" style="margin-top: 0px;">
	...
	<div class="widget-body" style="padding: 0;">
		...
		<form  method="post" action="editUserListServlet?um_old=<%=um_old%>&editpage=<%=thispage %>" class="form" onsubmit="return check(this)" >
		<table class="table table-bordered table-condensed table-striped table-primary table-vertical-center checkboxs">
			...
			for (int i=(thispage-1)*20;i<thispage*20;i++){
				...
				User u= users.get(i);
				if (!u.getUserName().equals(um_old)){
			 %>
				<tr class="selectable">
				...
				<tr class="selectable">
					<td class="center uniformjs"></td>
					<td class="center">
						<input type="text" name="userName" id="userName" style="height:20px;"
						placeholder="<%=u.getUserName() %>"></td>
					<td class="center">
						<input type="text" name="password" id="password"  style="height:20px;"
						placeholder="<%=u.getPassword() %>"></td>
					
					<td class="center">
						<input type="submit" value="确认" >
						<input type="button" value="取消" onclick="javascrtpt:window.location.href='adminUserList.jsp?page=<%=thispage%>'">
					</td>
				</tr>				
				<%}} %>		
		  </tbody>
