...
var addstr= decodeURI(document.URL);
var num=addstr.indexOf("?");
addstr=addstr.substr(num+1);

var pfile=decodeURIComponent(addstr); 
...
function WebOpen()
{
	...
	if (obj)setTimeout('openfile()',100);//等待控件初始化完毕，时间可以根据网络速度设定。
}

function openfile()
{
	
	document.getElementById('WebOffice').Open(strOpenUrl,true,"pdf","","");
}
...
function myFunction(){
	...
	location.href= "http://localhost:8080/FileManagement/servlet/readServlet?read="+pfile;
}
   ...
   <body topmargin=0 leftmargin=0 onload="javascript:WebOpen();" onunload="myFunction()">
